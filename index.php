...
<?php $homePic = picture($home['heroImage'] ?? [], '(min-width: 1200px) 1152px, calc(100vw - 32px)', 'eager'); if ($homePic !== ''): ?><section class="wrap home-band"><?= $homePic ?></section><?php endif; unset($homePic); ?>
