...
<h1><?= e($tmRecord['title']) ?></h1><p class="lead"><?= e($tmRecord['lead']) ?></p>
<section class="section--tight"><h2><?= e(ui('foundation.timeline')) ?></h2><ol class="timeline"><?php foreach ($tmRecord['timeline'] as $tmEntry): ?><li><a class="timeline__wk" href="<?= e('/semana/' . $tmEntry['week'] . '/') ?>"><?= e(ui('foundation.week') . ' ' . $tmEntry['week']) ?></a><span class="timeline__what"><?= e($tmEntry['what']) ?></span></li><?php endforeach; ?></ol></section>
