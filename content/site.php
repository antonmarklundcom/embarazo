...
return [
    ...
    'analytics' => null,
    'contact' => ['whatsapp' => '+595 995 628 862', 'phone' => null, 'email' => null],
    ...
    // Matches NEXT_PUBLIC_BUSINESS_WHATSAPP in the app repo (embarazo.2.1) — the
    // two must stay in sync; see docs/app-facts.md.
    'phone'    => null,
