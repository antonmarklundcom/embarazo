...
<div class="stack"><?php foreach ($rlRecords as $rlRecord): ?><a class="article-card" href="<?= e($rlRecord['path']) ?>"><span class="article-card__thumb" aria-hidden="true">↗</span><div class="article-card__body"><h3><?= e($rlRecord['title']) ?></h3><p><?= e($rlRecord['metaDescription']) ?></p></div></a><?php endforeach; ?></div></section><?php endif; ?>
