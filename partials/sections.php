...
<?php foreach ($bsSection['body'] ?? [] as $bsParagraph): ?><p><?= e($bsParagraph) ?></p><?php endforeach; ?>
<?php if (!empty($bsSection['items'])): ?><ul class="keyfacts"><?php foreach ($bsSection['items'] as $bsItem): ?><li><span><?= e($bsItem['title'] ?? '') ?></span><b><?= e($bsItem['text'] ?? '') ?></b></li><?php endforeach; ?></ul><?php endif; ?>
